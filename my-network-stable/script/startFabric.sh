...
cd ../first-network
echo y | ./byfn.sh down
echo y | ./byfn.sh up -o etcdraft -a -n -s couchdb
...
#ORG3_MSPCONFIGPATH=${CONFIG_ROOT}/crypto/peerOrganizations/org3.thirdparty.com/users/Admin@org3.thirdparty.com/msp
#ORG3_TLS_ROOTCERT_FILE=${CONFIG_ROOT}/crypto/peerOrganizations/org3.thirdparty.com/peers/peer0.org3.thirdparty.com/tls/ca.crt
...
#  -e CORE_PEER_ADDRESS=peer0.org3.thirdparty.com:9051 \
